...
import logoDev from '../imagens/attachment_107446690.jpeg'
            ...
            <AppBar position="static">
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        ...
                        <Avatar sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} alt="Logo IFSUL" src={logoDev} />
                        <Typography
                            variant="h6"
                            noWrap
                        ...
                        <Box sx={{ flexGrow: 0 }}>
                            <Tooltip title="Menu do usuário">
                                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}
                                    color="inherit">
                                    <Typography >{!user ? "Autenticar" : <> {user?.email}
                                    </>}</Typography>
                                    <AccountCircle />
                                </IconButton>
                            </Tooltip>
